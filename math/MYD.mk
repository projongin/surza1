###########################################################################
## Makefile generated for Simulink model 'MYD'. 
## 
## Makefile     : MYD.mk
## Generated on : Tue Oct 16 13:21:22 2018
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\MYD.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = F:\WORK_KO\Models_MatLab\USHRT_Starorusskay\math
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = MYD_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = MYD_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\MYD.exe
...
INCLUDES_BUILDINFO = $(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\MYD_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=MYD -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\MYD_ert_rtw\MYD.c $(START_DIR)\MYD_ert_rtw\MYD_data.c

MAIN_SRC = $(START_DIR)\MYD_ert_rtw\ert_main.c
...
{$(START_DIR)\MYD_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\MYD_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
